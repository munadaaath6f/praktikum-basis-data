...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 02 Jun 2026 pada 20.36
...
ALTER TABLE `produk`
  ...
  ADD UNIQUE KEY `idx_unique_kode_produk` (`kode_produk`),
  ADD UNIQUE KEY `idx_unique_nama_produk` (`nama_produk`);
